...
\ThesisTitle{Measuring properties of the \\Higgs boson utilizing off-shell production in \(\text{H}^* \rightarrow \text{ZZ} \rightarrow \mathbf{4\ell}\) at the \\CERN Large Hadron Collider}
